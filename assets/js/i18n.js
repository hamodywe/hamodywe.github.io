...
export const STRINGS = {
  en: {
    ...
    'nav.home': 'Home',
    'nav.tools': 'Tools',
    'cta.tools': 'Browse the tools',
    'cta.contributions': 'See contributions',
    'home.selected': 'Selected tools',
  ...
  ar: {
    ...
    'nav.home': 'الرئيسية',
    'nav.tools': 'الأدوات',
    'cta.tools': 'استعرض الأدوات',
    'cta.contributions': 'شاهد المساهمات',
    'home.selected': 'أدوات مختارة',
